...
const ForgotPassword = () => {
    ...
    const forgotPassword = async () => {
      try {
        ...
        const response = await axios.post(`${API_END_POINT}/forgot-password`, { email }); // Make API call
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
      ...
      if (!email) {
        toast.error("Please enter a valid email address"); // Handle empty email case
        return;
      }
      forgotPassword();
    };
