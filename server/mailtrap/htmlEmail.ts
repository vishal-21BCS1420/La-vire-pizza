export const htmlContent: string = `
    ...
    <body>
        <div class="container">
            ...
            <div class="footer">
                <p>&copy; 2025 La vire pizza. All rights reserved.</p>
            </div>
        </div>
    </body>
    </html>
            ...
            <body>
              <div class="email-container">
                ...
                <div class="email-body">
                  ...
                  <p>We are excited to have you on board at La vire pizza. Explore our platform and enjoy our services.</p>
                  <p>If you have any questions or need assistance, feel free to reach out to us.</p>
                  <p>Best Regards,<br/>La vire pizza</p>
                </div>
...
export const generatePasswordResetEmailHtml = (resetToken:string) => {
        ...
        <body>
          <div class="email-container">
            ...
            <div class="email-body">
              ...
              <p>Thank you,<br/>La vire pizza</p>
            </div>
            <div class="email-footer">
              <p>&copy; 2025  La vire pizza. All rights reserved.</p>
            </div>
